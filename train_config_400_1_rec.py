...
fonts = ['example/TextBPNPlusPlus/dataset/MyGenerator/font.ttf','example/TextBPNPlusPlus/dataset/MyGenerator/XO_Oriel_Bi.ttf','example/TextBPNPlusPlus/dataset/MyGenerator/consolas/consola.ttf']
